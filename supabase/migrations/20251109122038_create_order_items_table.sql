...
CREATE
POLICY "Users can view items for their own orders"
...
CREATE
POLICY "Users can add items to their own orders"
    ON public.order_items
    FOR INSERT
    TO authenticated
    WITH CHECK (
...
CREATE
POLICY "Users can update items in their own orders"
    ON public.order_items
    FOR
UPDATE
    TO authenticated
...
CREATE
POLICY "Users can delete items from their own orders"
    ON public.order_items
    FOR DELETE
TO authenticated
    USING (
